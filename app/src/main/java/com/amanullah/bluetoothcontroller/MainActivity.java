package com.amanullah.bluetoothcontroller;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button aButton = findViewById(R.id.aButtonId);
        final Button bButton = findViewById(R.id.bButtonId);
        final TextView showTextview = findViewById(R.id.showTextviewId);

        aButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showTextview.setText("A");
